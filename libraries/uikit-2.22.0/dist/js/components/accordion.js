...
(function(addon) {
    ...
    UI.component('accordion', {
        ...
        defaults: {
            ...
            easing     : 'swing',
            duration   : 300,
            toggle     : '.i-accordion-title',
            containers : '.i-accordion-content',
            clsactive  : 'i-active'
        },
        ...
        boot:  function() {
            ...
            UI.ready(function(context) {
                ...
                setTimeout(function(){
                    ...
                    UI.$("[data-i-accordion]", context).each(function(){

                        var ele = UI.$(this);

                        if(!ele.data("accordion")) {
                            UI.accordion(ele, UI.Utils.options(ele.attr('data-i-accordion')));
                        }
                    });
