...
(function(addon) {
    ...
    UI.component('nestable', {
        ...
        defaults: {
            listBaseClass   : 'i-nestable',
            listClass       : 'i-nestable-list',
            listItemClass   : 'i-nestable-item',
            dragClass       : 'i-nestable-dragged',
            movingClass     : 'i-nestable-moving',
            emptyClass      : 'i-nestable-empty',
            handleClass     : '',
            collapsedClass  : 'i-collapsed',
            placeholderClass: 'i-nestable-placeholder',
            noDragClass     : 'i-nestable-nodrag',
            group           : false,
            maxDepth        : 10,
            threshold       : 20,
            idlethreshold   : 10,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-i-nestable]", context).each(function(){

                    var ele = UI.$(this);

                    if (!ele.data("nestable")) {
                        UI.nestable(ele, UI.Utils.options(ele.attr("data-i-nestable")));
                    }
                });
            });
        },
        ...
        setParent: function(li) {
            ...
            if (li.children(this.options._listClass).length) {
                li.addClass("i-parent");
            }
        },

        unsetParent: function(li) {
            li.removeClass('i-parent '+this.options.collapsedClass);
