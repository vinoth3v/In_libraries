...
(function(addon) {
    ...
    UI.component('sortable', {
        ...
        defaults: {
            ...
            childClass       : 'i-sortable-item',
            placeholderClass : 'i-sortable-placeholder',
            overClass        : 'i-sortable-over',
            draggingClass    : 'i-sortable-dragged',
            dragMovingClass  : 'i-sortable-moving',
            baseClass        : 'i-sortable',
            noDragClass      : 'i-sortable-nodrag',
            emptyClass       : 'i-sortable-empty',
            dragCustomClass  : '',
            handleClass      : false,
            group            : false,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-i-sortable]", context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data("sortable")) {
                        UI.sortable(ele, UI.Utils.options(ele.attr("data-i-sortable")));
                    }
                });
            });
